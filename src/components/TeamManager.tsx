...
export const TeamManager: React.FC = () => {
  ...
  const updatePlayerTeam = (activeTeam: IPokemon[], inventory: IPokemon[]) => {
    setPlayer({
      ...player,
      activeTeam,
      inventory,
  ...
  const handleSwap = (pokemon: IPokemon, isMovingToTeam: boolean) => {
  ...
  const handleFree = (pokemon: IPokemon) => {
